...
export const QueueNavigation = StackNavigator(
  { Queue: { screen: Queue }, },
  { initialRouteName: 'Queue'},
);

export const UserPodcastsNavigation = StackNavigator(
  { UserPodcasts: { screen: UserPodcasts }, },
  { initialRouteName: 'UserPodcasts'},
);
...
export const DiscoverNavigation = StackNavigator(
  { Show: { screen: Show }, Discover: { screen: Discover },},
